...
class Control extends Module {
  ...
  val signals =
    ListLookup(io.opcode,
      ...
      //LW
      BitPat("b0000011") -> List(false.B, false.B, false.B, true.B,  false.B, true.B,   1.U,    0.U,      true.B,  false.B, true.B,  0.U, true.B),
      //LUI
      BitPat("b0110111") -> List(false.B, false.B, false.B, false.B, false.B, true.B,   0.U,    1.U,      true.B,  false.B, false.B, 3.U, true.B),
      //AUIPC
      BitPat("b0010111") -> List(false.B, false.B, false.B, false.B, false.B, true.B,   0.U,    0.U,      true.B,  true.B,  false.B, 3.U, true.B),
      //SW
      BitPat("b0100011") -> List(false.B, false.B, false.B, false.B, true.B,  true.B,   1.U,    0.U,      true.B,  false.B, true.B,  0.U, true.B),
      //BRANCH
      BitPat("b1100011") -> List(true.B,  true.B,  false.B, false.B, false.B, false.B,  0.U,    0.U,      false.B, false.B, false.B, 1.U, true.B),
      //JAL
      BitPat("b1101111") -> List(true.B,  false.B, true.B,  false.B, false.B, false.B,  0.U,    2.U,      true.B,  false.B, false.B, 3.U, true.B),
      //JALR
      BitPat("b1100111") -> List(true.B,  false.B, true.B,  false.B, false.B, false.B,  0.U,    2.U,      true.B,  false.B, true.B,  3.U, true.B),
      //BitPat("b00000") -> List(branch, pcfromalu, jump, memread, memwrite, regwrite, toreg, resultselect, alusrc,  pcadd,   itype,   aluop, true.B),
      //BitPat("b00000") -> List(branch, pcfromalu, jump, memread, memwrite, regwrite, toreg, resultselect, alusrc,  pcadd,   itype,   aluop, true.B),
